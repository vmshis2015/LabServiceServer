...
namespace Vietbait.Lablink.Devices.Immunology
{
    ...
    internal class _CI4100Test
    {
        ...
        public void HeaderTest()
        {
            try
            {
                const string rawHeader = @"H|\^&||||||||||P|1";
                var oldHeader = new CI4100HeaderRecord();
                oldHeader.Parse(rawHeader);
                //h.Parse(rawHeader);
                Debug.WriteLine(oldHeader.RecordType);
                var newHeader = new CI4100HeaderRecord();             
        ...
        public void ResultTest()
        {
            try
            {
                ...
                var newHeader = new CobasE6000ResultRecord(@"R|1|^^^64/1/not|46.22|IU/L||H||F||BMSERV|20050915150011||E11");
        ...
        public void QueryTest()
        {
            try
            {
                ...
                var newHeader = new CobasE6000RequestInformationRecord(@"Q|1|^^121108010001          ^1^5032^1^^S1^SC^R1||ALL||||||||O");
                //var tempP = new CobasE6000PatientInformationRecord(@"P|1|||||||M||||||35^Y||||||||||||||||||||");
                //Debug.WriteLine(tempP.Create());
