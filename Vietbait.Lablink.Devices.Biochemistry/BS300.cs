    ...
    internal class BS300 : TcpIpDevice
    {
        ...
        public override void ProcessRawData()
        {
            try
            {
                ...
                {
                    string resultItem = rawData.Substring(0, rawData.IndexOf(DeviceHelper.FS) + 1);
        ...
        private void ProcessResult(string resultItem)
        {
            try
            {
                ...
                string sendData = string.Format("{0}{1}{2}MSA|AA|1|Message accepted|||0|{3}{4}{5}", DeviceHelper.VT,
