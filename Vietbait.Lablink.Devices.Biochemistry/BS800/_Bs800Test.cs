    ...
    internal class _Bs800Test
    {
        ...
        public void HeaderTest()
        {
            try
            {
                ...
                var oldHeader = new Bs800HeaderRecord();
                oldHeader.Parse(rawHeader);
                //h.Parse(rawHeader);
                Debug.WriteLine(oldHeader.RecordType);
                var newHeader = (Bs800HeaderRecord) oldHeader.Clone();
        ...
        public void OrderTest()
        {
            try
            {
                const string rawHeader =
                    @"O|1|1^1^1|SAMPLE123|1^Test1^2^1\2^Test2^2^1\3^Test3^2^1\4^Test4^2^1|R|20090910135300|20090910125300|||John|||||Urine|Dr.Who|Department1|1|Dr.Tom||||||O|||||";
        ...
        public void ResultTest()
        {
            try
            {
                ...
                var newHeader =
                    new Bs800ResultRecord(
                        @"R|24|001^Calcium^^F|2.549481^^^^|mmol/L|^|N||F|2.549481^^^^|0|20130705123028||Mindry^");
