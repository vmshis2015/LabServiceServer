...
{
    [Serializable]
    public class Bs800PatientInformationRecord : AstmBaseRecord
    {
        ...
        public Bs800PatientInformationRecord() : this(string.Empty)
        {
        }

        public Bs800PatientInformationRecord(string rawString)
        {
