...
{
    public abstract class TcpIpASTMManager : TcpIpDevice //,IRS232Communication
    {
        ...
        public TcpIpASTMManager()
        {
            try
            {
                ...
                objDataEventArgs = new ExternalDataEventArgs(InstanceId) {WaitForIdle = true};
        ...
        public override void OnInCommingData(object obj)
        {
            try
            {
                ...
                if (rawData != null)
                {
                    ...
                    _tempbuffer = string.Concat(_tempbuffer, Encoding.UTF8.GetString(allbyte));
                    ...
                    foreach (byte onebyte in allbyte)
                    {
                        ...
                        else if (onebyte.Equals((byte) DeviceHelper.LF))
                        {
                            ...
                            string temp = DeviceHelper.GetStringAfterCheckSum(allbyte);
                        ...
                        else if (onebyte.Equals((byte) DeviceHelper.EOT))
                        {
                            ...
                            if (_prvRequestArray == null || _prvRequestArray.Count == 0) continue;
                        ...
                        else if (onebyte.Equals((byte) DeviceHelper.ACK))
                        {
                                ...
                                (_currentOrderIdx < _currentOrder.Count))
                            {
                                ...
                                _currentOrderIdx++;
                                Log.Debug("Send String Data:\r\n{0}", _prvLastStringRequest);
