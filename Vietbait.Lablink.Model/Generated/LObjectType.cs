...
namespace Vietbait.Lablink.Model
{
    ...
    /// </summary>
    [Serializable]
    public class LObjectTypeCollection : ActiveList<LObjectType, LObjectTypeCollection>
    {
        /// <summary>
    ...
    /// <summary>
    ///     This is an ActiveRecord class which wraps the L_ObjectType table.
    /// </summary>
    [Serializable]
    public class LObjectType : ActiveRecord<LObjectType>, IActiveRecord
    {
        ...
        private static void GetTableSchema()
        {
            ...
            {
                //Schema declaration
                var schema = new TableSchema.Table("L_ObjectType", TableType.Table, DataService.GetInstance("ORM"));
                ...
                DataService.Providers["ORM"].AddSchema("L_ObjectType", schema);
            }
        }
