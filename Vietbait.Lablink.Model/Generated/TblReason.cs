...
{
    /// <summary>
    ///     Strongly-typed collection for the TblReason class.
    /// </summary>
    [Serializable]
    public class TblReasonCollection : ActiveList<TblReason, TblReasonCollection>
    {
        /// <summary>
        ///     Filters an existing collection based on the set criteria. This is an in-memory filter
        ///     Thanks to developingchris for this!
        /// </summary>
        /// <returns>TblReasonCollection</returns>
        public TblReasonCollection Filter()
        {
    ...
    /// <summary>
    ///     This is an ActiveRecord class which wraps the tbl_Reason table.
    /// </summary>
    [Serializable]
    public class TblReason : ActiveRecord<TblReason>, IActiveRecord
    {
        ...
        public TblReason(bool useDatabaseDefaults)
        {
            SetSQLProps();
        ...
        public TblReason(string columnName, object columnValue)
        {
            SetSQLProps();
            InitSetDefaults();
        ...
        private static void GetTableSchema()
        {
            ...
            {
                //Schema declaration
                var schema = new TableSchema.Table("tbl_Reason", TableType.Table, DataService.GetInstance("ORM"));
                ...
                DataService.Providers["ORM"].AddSchema("tbl_Reason", schema);
            }
        }
