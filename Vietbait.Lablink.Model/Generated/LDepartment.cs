...
namespace Vietbait.Lablink.Model
{
    ...
    /// </summary>
    [Serializable]
    public class LDepartmentCollection : ActiveList<LDepartment, LDepartmentCollection>
    {
        /// <summary>
    ...
    /// </summary>
    [Serializable]
    public class LDepartment : ActiveRecord<LDepartment>, IActiveRecord
    {
        ...
        private static void GetTableSchema()
        {
            ...
            {
                //Schema declaration
                var schema = new TableSchema.Table("L_Department", TableType.Table, DataService.GetInstance("ORM"));
