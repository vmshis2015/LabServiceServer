...
{
    /// <summary>
    ///     Strongly-typed collection for the LManufacture class.
    /// </summary>
    [Serializable]
    public class LManufactureCollection : ActiveList<LManufacture, LManufactureCollection>
    {
        /// <summary>
        ///     Filters an existing collection based on the set criteria. This is an in-memory filter
        ///     Thanks to developingchris for this!
        /// </summary>
        /// <returns>LManufactureCollection</returns>
        public LManufactureCollection Filter()
        {
            for (int i = Count - 1; i > -1; i--)
            {
                LManufacture o = this[i];
    ...
    /// <summary>
    ///     This is an ActiveRecord class which wraps the L_MANUFACTURE table.
    /// </summary>
    [Serializable]
    public class LManufacture : ActiveRecord<LManufacture>, IActiveRecord
    {
        ...
        public LManufacture(bool useDatabaseDefaults)
        {
            SetSQLProps();
        ...
        public LManufacture(object keyID)
        {
            SetSQLProps();
            InitSetDefaults();
            LoadByKey(keyID);
        ...
        public LManufacture(string columnName, object columnValue)
        {
            SetSQLProps();
            InitSetDefaults();
        ...
        private static void GetTableSchema()
        {
            ...
            {
                //Schema declaration
                var schema = new TableSchema.Table("L_MANUFACTURE", TableType.Table, DataService.GetInstance("ORM"));
